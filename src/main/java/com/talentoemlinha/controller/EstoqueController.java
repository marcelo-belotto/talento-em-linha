...
//         Brinde brindeTemp = Brinde.brindesMocados().get(estoqueDto.getIdBrinde() - 1); // TEMPORÀRIO VAI DAR ERRO COM
//                                                                                        // BRINDES NOVOS CADASTRADOS
//                                                                                        // DEVIDO AO METODO STATIC
//         if (brindeTemp == null)
//             return null; // Melhorar a resposta http
